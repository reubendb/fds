...
REAL(EB) :: UBAR,VBAR,WBAR,UREL,VREL,WREL,QREL,RHO_G,TMP_G,MU_FILM, &
            ...
            X_WGT2,Y_WGT2,Z_WGT2,GX_LOC,GY_LOC,GZ_LOC,DRAG_MAX(3)=0._EB,K_SGS,U_P,KN,M_DOT,&
            EMBER_DENSITY,EMBER_VOLUME,ACCEL_X,ACCEL_Y,ACCEL_Z,LP_FORCE,FACE_VOLS(0:1,0:1,0:1)
REAL(EB), SAVE :: BETA
INTEGER :: IIX,JJY,KKZ,IL,JL,KL
...
DO AXIS=1,3
   ...
   X_WGT3 = X_WGT; Y_WGT3 = Y_WGT; Z_WGT3 = Z_WGT;
   IF (AXIS == 1) THEN
   ...
   CALL GET_FACE_VOLUMES(NM,AXIS,IL,JL,KL,FACE_VOLS)
   CALL PARTICLE_TO_MESH(LP_FORCE,FVX_D,FACE_VOLS,IL,JL,KL,X_WGT3,Y_WGT3,Z_WGT3)
