...
REAL(EB) :: UBAR,VBAR,WBAR,UREL,VREL,WREL,QREL,RHO_G,TMP_G,MU_FILM, &
            ...
            X_WGT3,Y_WGT3,Z_WGT3,GX_LOC,GY_LOC,GZ_LOC,DRAG_MAX(3)=0._EB,K_SGS,U_P,KN,M_DOT,&
...
DO AXIS=1,3
   ...
   CALL PARTICLE_TO_MESH(LP_FORCE,FV_D,FACE_VOLS,IL,JL,KL,X_WGT3,Y_WGT3,Z_WGT3)
